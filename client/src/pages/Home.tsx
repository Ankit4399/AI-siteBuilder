    ...
    const onSubmitHandler = async (e: React.FormEvent) => {
        ...
        try {
          if(!session?.user){
            ...
            return toast.error("Please provide a valid input");
          }
          setLoading(true);
  ...
  return (
      ...
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <div className="flex flex-wrap items-center justify-center gap-16 md:gap-20 mx-auto mt-16">
          <img className="max-w-28 md:max-w-32 opacity-70 hover:opacity-100 transition-opacity" src="/companies-logo/framer.svg" alt="Framer" />
          <img className="max-w-28 md:max-w-32 opacity-70 hover:opacity-100 transition-opacity" src="/companies-logo/huawei.svg" alt="Huawei" />
          <img className="max-w-28 md:max-w-32 opacity-70 hover:opacity-100 transition-opacity" src="/companies-logo/instagram.svg" alt="Instagram" />
          <img className="max-w-28 md:max-w-32 opacity-70 hover:opacity-100 transition-opacity" src="/companies-logo/microsoft.svg" alt="Microsoft" />
          <img className="max-w-28 md:max-w-32 opacity-70 hover:opacity-100 transition-opacity" src="/companies-logo/walmart.svg" alt="Walmart" />
        </div>
      </section>
  )
}
