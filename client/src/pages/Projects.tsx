...
const Projects = () => {
  ...
  const [device,setDevice] = useState< 'tablet' | 'desktop' | 'phone'>('desktop');
  ...
  // Download code function(index.html)
  const downloadCode = () =>{
      ...
      <div className='flex max-sm:flex-col sm:items-center gap-4 px-4 py-2 no-scrollbar'>
        ...
        <div className='flex items-center gap-2 sm:min-w-90 text-nowrap'>
          ...
          <div className='max-w-64 sm:max-w-xs'>
            ...
            <p className='text-xs text-gray-400 -mt-05'>Previewing last saved version</p>
          </div>
          <div className='sm:hidden flex-1 flex justify-end'>
            {isMenuOpen ? 
            <MessageSquareIcon onClick={()=> setIsMenuOpen(false)} className='sie-6 cursor-pointer' /> 
