...
export const makeRevision = async (req: Request,res: Response) =>{
    ...
    try {
        ...
        const message = (Array.isArray(req.body.message) ? req.body.message[0] : req.body.message) as string;
...
// controller to rollback to a specific version
export const rollbackToVersion = async (req: Request,res: Response) =>{
    try {
        ...
        const projectId = (Array.isArray(req.params.projectId) ? req.params.projectId[0] : req.params.projectId) as string;
        const versionId = (Array.isArray(req.params.versionId) ? req.params.versionId[0] : req.params.versionId) as string;
...
export const saveProjectCode = async (req: Request,res: Response) =>{
    try {
       ...
       const code = (Array.isArray(req.body.code) ? req.body.code[0] : req.body.code) as string;
       if(!userId){
            return res.status(401).json({message : "Unauthorized"})
       }
       if(!code){
